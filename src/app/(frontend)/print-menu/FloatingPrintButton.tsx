...
const FloatingPrintButton: React.FC = () => {
  ...
  const scheduleHideButton = useCallback(() => {
    ...
    activityTimerRef.current = setTimeout(hideButton, 3000) // 3-second delay
  }, [hideButton])
  ...
  useEffect(() => {
    ...
    activateButton() // Show initially and start timer
  ...
  const handleMouseEnter = () => {
    ...
    setIsVisible(true) // Ensure it's visible when mouse enters
  }
